// Local-dev copy of the saved-visualisation store used by the Express server.
// KEEP IN SYNC with the deployed Vercel copy in client/api/_lib/savedVisualisationsStore.ts.
import { randomUUID } from 'node:crypto'
import { describeDbError, getCollection } from './db'
import type { OwnerScope } from './clientsStore'
import { getRevision, markRevisionSaved, type GenerationContext } from './revisionsStore'
