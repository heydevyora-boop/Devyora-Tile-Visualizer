// Deployed copy used by the Vercel serverless functions in client/api/.
// Vercel only uploads files under the project Root Directory (client/), so
// there is no server/ equivalent of this file — Google Drive upload is a
// production/Vercel-only feature for now.
